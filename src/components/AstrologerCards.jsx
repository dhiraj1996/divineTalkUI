...
const AstrologerCards = ({data}) => {
  return (
    <>
      ...
      <div className="flex justify-between p-3 lg:p-4 rounded-lg shadow-lg border border-gray-200 h-[133px] lg:h-auto">
        ...
        <div className="text-primary w-36 lg:w-36">
        ...
        <div className="flex flex-col justify-between items-center">
          ...
          <div className="text-center">
            <button className={`py-1 px-7 lg:px-4 lg:py-1 font-semibold  border ${data.wait ? "border-secondary text-secondary": "border-tertiary text-tertiary"} rounded-[10px]`}>
              Chat
            </button>
